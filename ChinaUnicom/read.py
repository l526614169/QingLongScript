...
"""
-------------------------------
@Author : github@limoruirui https://github.com/yuanter/misaka/blob/master/china_unicom.py
...
if __name__ == "__main__":
    unicom_lotter = get_environ("UNICOM_LOTTER", True, False)
    """读取环境变量"""
    l = []
    user_map = get_environ("PHONE_NUM").split(",")
